...
private object LibraryVersion {
    ...
    const val THREE_TEN = "1.2.4"
    const val A_X_BROWSER = "1.0.0"
    const val MP_A_CHART = "v3.1.0"
    const val MT_CTOOLBAR_SUBTITLE = "1.1.0"
    const val SDS_EXP_LAYOUT = "1.0.5"
...
object LibraryDependency {
    ...
    const val DESIGN = "com.android.support:design:${LibraryVersion.DESIGN}"
    ...
    const val THREE_TEN_ABP = "com.jakewharton.threetenabp:threetenabp:${LibraryVersion.THREE_TEN}"
    const val ANDROID_X_BROWSER = "androidx.browser:browser:${LibraryVersion.A_X_BROWSER}"
